...
export const createPolicyPermissionColumns = ({ theme, onEdit, onDelete }: CreatePolicyPermissionColumnsProps): ColumnDef<PolicyPermission>[] => [
  {
    accessorKey: 'policy_id',
    header: 'Policy ID',
    cell: ({ row }) => (
      <div className={`text-sm font-mono ${theme === 'dark' ? 'text-zinc-400' : 'text-gray-600'}`}>
